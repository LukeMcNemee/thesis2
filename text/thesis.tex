...
\chapter{Education use}
  ...
  \paragraph{reviewer part of a scenario}
    ...
    The point of the excercise is to deal the probem at hand without complicating it with anything else. Of course we could add any advanced key distribution schemes  %CITE
    ...
    Nevertheless, it is very likely that such attacker would like to cause any kind of damage he is capable of doing. Most likely to make the application, protocol, or netwok unavailable; most likely by DoS attack %CITE
