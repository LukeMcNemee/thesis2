...
\chapter{Research use}\label{ch:research}
  ...
  As we can see from data collected in experiments during undisturbed network \ref{src:plain}, there no bits generated and that is the case for most of the time. To deal with this problem, we have to introduce some form of artificial noise or disturbances.
